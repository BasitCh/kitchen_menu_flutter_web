...
import 'package:widgets_book/src/presentation/colors_page.dart';
import 'package:widgets_book/src/presentation/spacing_page.dart';
import 'package:widgets_book/src/presentation/typography_page.dart';
import 'package:widgets_book/src/presentation/widgets_page.dart';
...
class RootPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('App Widget BooK')),
