...
class AppButton extends StatelessWidget {
  ...
  const AppButton.outlinedDarkRed({
    required Widget child,
    Key? key,
    VoidCallback? onPressed,
    double? elevation,
  ...
  const AppButton.outlinedBlack({
    ...
    buttonColor: AppColors.transparent,
    child: child,
    foregroundColor: AppColors.textBlack80,
    elevation: elevation,
    textStyle: textStyle,
    radius: radius ?? 8,
    borderSide: const BorderSide(color: AppColors.textBlack80),
  );

  const AppButton.outlinedCoral({
    required Widget child,
    Key? key,
    VoidCallback? onPressed,
    double? elevation,
    ...
    buttonColor: AppColors.transparent,
    child: child,
    foregroundColor: AppColors.coral2,
    elevation: elevation,
    textStyle: textStyle,
    radius: radius ?? 8,
    borderSide: const BorderSide(color: AppColors.coral2),
  );
  ...
  const AppButton.grey({
    ...
    Size? maximumSize,
          ...
          key: key,
          onPressed: onPressed,
          buttonColor: AppColors.charcool,
          child: child,
          foregroundColor: AppColors.white800,
          elevation: elevation,
          textStyle: textStyle,
  ...
  const AppButton.outlinedDarkBorder({
    required Widget child,
    Key? key,
    VoidCallback? onPressed,
    double? elevation,
