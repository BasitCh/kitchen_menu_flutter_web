...
abstract class AppColors {
  ...
  static const Color black200 = Color(0x7F23262E);

  /// Light black
  static const Color lightBlack = Colors.black54;

  static const Color black600 = Color(0xFFC3C2C2);

  /// White
  static const Color white = Color(0xFFFFFFFF);

  static const Color white900 = Color(0xFFF4F2F2);

  // White light shade
  static const Color white800 = Color(0xFFF4F2F2);

  static const Color white700 = Color(0xFFf8f7f7);

  /// Transparent
  static const Color transparent = Color(0x00000000);

  /// The grey primary color and swatch. background: #DCDEE7;
  static const MaterialColor grey = Colors.grey;

  static const Color greyBg = Color(0xFFDCDEE7);
  ...
  static const Color lightRed = Color(0xFFB3261E);
  static const Color hoverColor = Color(0xFFF4DEDD);

  /// The green primary color and swatch.
  static const MaterialColor green = Colors.green;

  static const Color greenDark = Color(0xFF106D3A);
  ...
  static const Color primaryColor = Color(0xFF35427C);
  ...
  static const Color splashBlue = Color(0xFFDAF0FD);
  ...
  static const Color primaryContainer = Color(0xFF2F4272);
  ...
  static const Color redLightWine = Color(0xFFA1221B);
  ...
  static const Color secondary = Color(0xFFF7E9E9);
  ...
  /// The default disabled foreground color.accent
  ...
  static const Color redDark = Color(0xFF3F0D0B);
  static const Color lightDark = Color(0xFFF4DEDD);
  static const Color darkGreen = Color(0xFF106D3A);
  static const Color seaGreen = Color(0xFF22A45D);
  static const Color textBlack50 = Color(0xFF525252);
  static const Color lightGreyDecent = Color(0xFFECECEC);
  static const Color grey100 = Color(0xFFC9C0C0);
  static const Color gray200 = Color(0xFFd0d0d0);
  static const Color gray700 = Color(0xFFb3b2b2);
  static const Color charcoal = Color(0xFF383E3B);
  // Coral
  static const Color coral = Color(0xFFf1e7e7);
  static const Color coral2 = Color(0xFFc29891);
  static const Color lightGrey = Color(0xFFF9F9F9);
  static const Color greybg = Color(0xFFCFCFCF);
  static const Color grey500 = Color(0xFFE0DFDF);

  //brown
  static const Color brown = Color(0xFF401917);
  static const Color whiteGrey = Color(0xFF545B72);
  static const Color whiteDada = Color(0xFFDADADA);
  static const Color mahroon = Color(0xFF771100);
  static const Color lightPink = Color(0xFFE7BCB9);
  static const Color lightPink100 = Color(0xFFFDF4F3);
  static const Color lightPink200 = Color(0xFFFDF6F5);
  static const Color dullGrey = Color(0xFF535353);
  static const Color charcool = Color(0xFF383F3B);
  static const Color stepGrey = Color(0xFF979797);
}
